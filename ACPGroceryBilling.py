print(" Welcome to Grocery Billing Queue")
...
while billing:                              
    ...
    item_count = int(input(f"Hello {name}! How many products are you buying? "))
 
    if item_count <= 0:
        print("Come on, stop messing around and enter an actual number!!!\n")
        continue
    ...
    while item_number <= item_count:       
        ...
        if price <= 0 or quantity <= 0:
            print("You typed incorrectly, Enter again\n")
            continue
