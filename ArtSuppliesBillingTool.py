def greet_customer():
    ...
    print("Get All the Art Supplies you can imagine Right here, Right now")
...
amount_paid = float(input("Enter how much money the customer paid: "))
...
def thank_you_message(items):
    if items >= 5:
        return "WOW!, You picked many art supplies for your project."
    else:
        return "Buy more next time, I am very Disappointed in you!"
